...
<div class="container-scroller">
    ...
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
            <a class="sidebar-brand brand-logo" href="index.html"><h1 style="color: lightyellow;font-family:cursive">Attendance </h1></a>
            <a class="sidebar-brand brand-logo-mini" href="index.html"><h1 style="color: lightyellow;font-family:cursive">A </h1></a>
        </div>
        <ul class="nav">
                ...
                <div class="profile-desc">
                    <div class="profile-pic">
                        <div class="count-indicator">
                            <img class="img-xs rounded-circle" src="<?php echo e(url('/uploads/image/'.Auth::guard('employee')->user()->photo)); ?>" alt="">
                            <span class="count bg-success"></span>
                        </div>
                        <div class="profile-name">
                            <h5 style="color: white" class="mb-0 font-weight-normal"><?php echo e(Auth::guard('employee')->user()->emp_name); ?></h5>
                            <span><?php echo e(Auth::guard('employee')->user()->department); ?></span>
                        </div>
                    </div>
                    <a href="#" id="profile-dropdown" data-toggle="dropdown"><i class="mdi mdi-dots-vertical"></i></a>
                    <div class="dropdown-menu dropdown-menu-right sidebar-dropdown preview-list" aria-labelledby="profile-dropdown">
                        <a href="<?php echo e(route('profile_view')); ?>" class="dropdown-item preview-item">
            ...
            <li class="nav-item menu-items">
                <a class="nav-link" href="<?php echo e(route('employee_dashboard')); ?>">
              ...
              <span class="menu-icon">
                ...
                <div class="collapse" id="ui-basic">
                    <ul class="nav flex-column sub-menu">
                        <li class="nav-item"> <a class="nav-link" href="<?php echo e(route('table')); ?>">View performance</a></li>
                    </ul>
                </div>
            </li>
    ...
    <div class="container-fluid page-body-wrapper">
        ...
        <nav class="navbar p-0 fixed-top d-flex flex-row">
            <div class="navbar-brand-wrapper d-flex d-lg-none align-items-center justify-content-center">
                <a class="navbar-brand brand-logo-mini" href="index.html"><img src="<?php echo e(url('assets/images/logo-mini.svg')); ?>" alt="logo" /></a>
            </div>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link" id="profileDropdown" href="#" data-toggle="dropdown">
                            <div class="navbar-profile">
                                <img class="img-xs rounded-circle" src="<?php echo e(url('/uploads/image/'.Auth::guard('employee')->user()->photo)); ?>" alt="">
                                <p class="mb-0 d-none d-sm-block navbar-profile-name"><?php echo e(Auth::guard('employee')->user()->emp_name); ?></p>
                        ...
                        <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="profileDropdown">
                            ...
                            <div class="dropdown-divider"></div>
                            <form method="post" action="<?php echo e(route('logout_employee')); ?>">
                                <?php echo csrf_field(); ?>
...
<?php /**PATH D:\laravel\employee_attendance_system2021\resources\views/EmployeeView/Masters/Main.blade.php ENDPATH**/ ?>