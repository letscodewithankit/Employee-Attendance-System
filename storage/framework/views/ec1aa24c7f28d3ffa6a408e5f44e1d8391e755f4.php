        ...
        <div class="row">
            <div class="col-md-5 mx-auto">
                <div class="card card-body">
                    <form id="submitForm" action="<?php echo e(route('employee_validate')); ?>" method="post" data-parsley-validate="" data-parsley-errors-messages-disabled="true" novalidate="" _lpchecked="1">
                        <?php echo csrf_field(); ?>
...
<?php /**PATH D:\laravel\employee_attendance_system2021\resources\views/EmployeeView/EmployeeLogin.blade.php ENDPATH**/ ?>