                ...
                <div class="profile-desc">
                    <div class="profile-pic">
                        <div class="count-indicator">
                            <img class="img-xs rounded-circle" src="{{url('/uploads/image/'.Auth::guard('employee')->user()->photo)}}" alt="">
                            <span class="count bg-success"></span>
                        </div>
                        <div class="profile-name">
                            <h5 style="color: white" class="mb-0 font-weight-normal">{{Auth::guard('employee')->user()->emp_name}}</h5>
                            <span>{{Auth::guard('employee')->user()->department}}</span>
                        </div>
                    </div>
                    <a href="#" id="profile-dropdown" data-toggle="dropdown"><i class="mdi mdi-dots-vertical"></i></a>
                    <div class="dropdown-menu dropdown-menu-right sidebar-dropdown preview-list" aria-labelledby="profile-dropdown">
                        <a href="{{route('profile_view')}}" class="dropdown-item preview-item">
              ...
              <span class="menu-icon">
                ...
                <div class="collapse" id="ui-basic">
                    <ul class="nav flex-column sub-menu">
                        <li class="nav-item"> <a class="nav-link" href="{{route('table')}}">View performance</a></li>
                    </ul>
                </div>
            </li>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link" id="profileDropdown" href="#" data-toggle="dropdown">
                            <div class="navbar-profile">
                                <img class="img-xs rounded-circle" src="{{url('/uploads/image/'.Auth::guard('employee')->user()->photo)}}" alt="">
                                <p class="mb-0 d-none d-sm-block navbar-profile-name">{{Auth::guard('employee')->user()->emp_name}}</p>
